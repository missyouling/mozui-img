...
<head>
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20viewBox%3D%270%200%2024%2024%27%3E%3Crect%20width%3D%2724%27%20height%3D%2724%27%20rx%3D%275.5%27%20fill%3D%27%230071E3%27%2F%3E%3Crect%20x%3D%273.6%27%20y%3D%273.6%27%20width%3D%2716.8%27%20height%3D%2716.8%27%20rx%3D%272.2%27%20fill%3D%27none%27%20stroke%3D%27%23fff%27%20stroke-width%3D%271.6%27%2F%3E%3Ccircle%20cx%3D%278.7%27%20cy%3D%278.7%27%20r%3D%271.35%27%20fill%3D%27%23fff%27%2F%3E%3Cpath%20d%3D%27m5.6%2018.6%204.1-4.1a1.6%201.6%200%200%201%202.26%200l2.35%202.35%203.15-3.15a1.6%201.6%200%200%201%202.26%200L22%2016.2%27%20fill%3D%27none%27%20stroke%3D%27%23fff%27%20stroke-width%3D%271.6%27%20stroke-linecap%3D%27round%27%20stroke-linejoin%3D%27round%27%2F%3E%3C%2Fsvg%3E">
  <style>
...
<body>
  ...
  <a href="https://github.com/missyouling/mozui-img" target="_blank" aria-label="GitHub 仓库" style="position:fixed;top:18px;right:18px;z-index:100;opacity:0.9;transition:opacity 0.2s,transform 0.2s;display:block" onmouseover="this.style.opacity=1;this.style.transform='scale(1.08)'" onmouseout="this.style.opacity=0.9;this.style.transform='scale(1)'">
    <svg width="34" height="34" viewBox="0 0 16 16" fill="#ffffff" style="filter:drop-shadow(0 1px 4px rgba(0,0,0,0.35))"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg>
  </a>
